 ...
 */
public class ChunkCipherV3Test {
    ...
    /**
     * Test {@link ChunkCipherV3} helper APIs.
     *
    ...
    public final void testChunkV1_HelperAPIs_Success() throws IonicException {
        ...
        Assert.assertEquals(ChunkCipherV3.ID, chunkCipher.getId());
        Assert.assertEquals(ChunkCipherV3.ID, chunkCipher.getLabel());
    }
     ...
     */
    @Test
    public final void testChunkV3_EncryptDecryptText_Success() throws IonicException {
        ...
        Assert.assertEquals(ChunkCipherV3.ID, chunkInfo.getCipherId());
     ...
     */
    @Test
    public final void testChunkV3_EncryptBytes_Success() throws IonicException {
     ...
     */
    @Test
    public final void testChunkV3_EncryptDecryptText_CodecSymmetry() throws IonicException {
        // setup Ionic test agent
        final KeyServices keyServices = IonicTestEnvironment.getInstance().getKeyServices();
        // check the test data
