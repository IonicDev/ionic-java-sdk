 ...
 */
public class ChunkCipherV1Test {
    ...
    /**
     * Test {@link ChunkCipherV1} helper APIs.
     *
    ...
    public final void testChunkV1_HelperAPIs_Success() throws IonicException {
        ...
        Assert.assertEquals(ChunkCipherV1.ID, chunkCipher.getId());
        Assert.assertEquals(ChunkCipherV1.ID, chunkCipher.getLabel());
    }
     ...
     */
    @Test
    public final void testChunkV1_EncryptDecryptText_Success() throws IonicException {
        ...
        Assert.assertEquals(ChunkCipherV1.ID, chunkInfo.getCipherId());
     ...
     */
    @Test
    public final void testChunkV1_EncryptDecryptBytes_Success() throws IonicException {
     ...
     */
    @Test
    public final void testChunkV1_EncryptDecryptText_CodecSymmetry() throws IonicException {
        // setup Ionic test agent
        final KeyServices keyServices = IonicTestEnvironment.getInstance().getKeyServices();
        // check the test data
