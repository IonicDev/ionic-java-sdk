...
public class EnrollIonicAuth {
     ...
     */
    public EnrollIonicAuth(final String url, final Agent agent,
    ...
    /**
     * Initiate the Ionic authentication transaction.
     *
    ...
    private HttpResponse submitAuthRequest(
        ...
        final byte[] entity = Transcoder.utf8().decode(String.format(Payload.REQUEST_AUTH,
